	...
	public kalkulator() {
		...
		btnsamadengan.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				System.out.println(tempString+" "+tempValue);
				if(isPass) {
					lblNotifikasi.setText("");
					for(looping=0;looping<tempLength-1;looping++){
//						System.out.println(looping+"#"+tempString+"#"+tempString.substring(looping, 1));
						System.out.println(tempString.substring(looping, 1));
					...
					//						tempValue = tempValue+ tempString.substring(looping, 1);
					System.out.println(tempVar1+" "+tempOperator+" "+tempVar2);
